...
import { Zap, Palette, Shield, Clock, Star, TrendingUp } from "lucide-react";

const features = [
  {
    icon: Zap,
    title: "원클릭 생성",
    description: "복잡한 설정 없이 클릭 한 번으로 프로페셔널한 의류컷을 완성하세요.",
  },
  {
    icon: Palette,
    title: "스타일 매칭",
  ...
  },
  {
    icon: Clock,
    title: "30초 완성",
    description: "기존 촬영 대비 100배 빠른 속도로 상품 이미지를 제작할 수 있어요.",
  },
  {
    icon: Shield,
    title: "일관된 퀄리티",
      ...
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
            왜 <span className="text-primary">Sellerhood</span>인가요?
          </h2>
          <p className="text-foreground-secondary text-lg max-w-lg mx-auto">
            복잡한 촬영 과정 없이, 누구나 쉽게 프로페셔널한 상품 이미지를 만들 수 있어요.
          </p>
        </div>

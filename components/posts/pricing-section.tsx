...
const plans = [
  {
    ...
    price: "무료",
    period: "",
    features: ["월 10회 생성", "기본 해상도", "이메일 지원", "워터마크 포함"],
    cta: "무료로 시작하기",
    href: "/signup",
    popular: false,
  },
  ...
  },
  {
    ...
    price: "문의",
    period: "",
    features: ["무제한 생성", "최고 해상도", "전담 매니저", "API 연동", "맞춤 트레이닝", "SLA 보장"],
    cta: "문의하기",
    href: "/#",
    popular: false,
  },
            ...
            >
              {plan.popular && (
                <div className="absolute -top-4 left-1/2 -translate-x-1/2">
                  <Badge className="bg-gradient-to-r from-primary to-primary-light text-primary-foreground shadow-lg shadow-primary/30">

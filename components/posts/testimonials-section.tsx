...
const testimonials = [
  {
    ...
    role: "여성의류 쇼핑몰 운영",
    content:
      "촬영 비용이 월 200만원에서 20만원으로 줄었어요. 퀄리티는 오히려 더 좋아졌고요.",
    rating: 5,
  },
  {
    name: "박준혁",
    role: "스트릿 브랜드 대표",
    content:
      "신상품 출시 속도가 2배 빨라졌습니다. 이제 촬영 때문에 출시를 미루는 일이 없어요.",
    rating: 5,
  },
  {
    name: "이수연",
    role: "빈티지샵 운영",
    content:
      "바닥컷으로 대충 찍은 사진도 쇼핑몰 퀄리티로 바꿔주니까 정말 신세계예요.",
    rating: 5,
  },
  {
    name: "최현우",
    role: "남성복 셀러",
    content:
      "일관된 스타일의 상품 이미지 덕분에 브랜딩이 확실해졌어요. 재구매율이 올랐습니다.",
    rating: 5,
  },
  {
    name: "정다은",
    role: "키즈 의류 쇼핑몰",
    content:
      "아이 모델 촬영이 너무 힘들었는데, 이제는 옷만 찍으면 끝이에요!",
    rating: 5,
  },
  {
    name: "한승민",
    role: "스포츠웨어 셀러",
    content:
      "상품 이미지 퀄리티가 좋아지니까 문의도 줄고 반품도 줄었어요.",
    rating: 5,
  },
];
      ...
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-foreground-secondary text-lg max-w-lg mx-auto">
            10,000명 이상의 셀러가 각자로 성공적인 결과를 만들고 있어요.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {testimonials.map((testimonial) => (
            ...
            >
              ...
              <div className="flex gap-1 mb-4" aria-label={`별점 ${testimonial.rating}점`}>
